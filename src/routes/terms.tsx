...
function TermsPage() {
  return (
    ...
    >
      ...
      <LegalSection heading="5. Merchant of Record">
        <p>
          Our order process is conducted by our online reseller{" "}
          <span className="text-foreground">Paddle.com</span>. Paddle.com is the{" "}
          <span className="text-foreground">Merchant of Record</span> for all our orders. Paddle
          provides all customer service inquiries and handles returns. Paddle is responsible for
          processing your order and payment, invoicing, and collecting and remitting applicable
          sales tax or VAT.
        </p>
        <p>
          Payment, billing, tax, invoicing, cancellation and refund mechanics are governed by{" "}
          <a
          ...
          , which apply to your purchase in addition to these terms.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="6. Subscriptions and billing">
        <p>
          ...
          cancellation stops future charges. Refunds are governed by our Refund Policy and are
      ...
      <LegalSection heading="7. Acceptable use">
        <ul className="space-y-1">
          ...
          <li>Do not use the service for fraud, spam, malware, or to interfere with its security.</li>
          <li>Do not use the service to provide regulated financial advice to third parties.</li>
        </ul>
      </LegalSection>

      <LegalSection heading="8. Intellectual property and your content">
        <p>
          We retain all ownership of ChartFusionX and its intellectual property, including the
          software, models, documentation and branding. You keep ownership of the trades, notes, and
          screenshots you upload, and you grant us a limited licence to store and process that
          content solely to operate the service for you, including sending it to AI providers when
          you request an AI feature.
        </p>
      </LegalSection>

      <LegalSection heading="9. Availability">
        <p>
          We aim for high availability but the service is provided "as is" and "as available", with
          no guarantee of uninterrupted or error-free performance. We may modify, suspend, or
          discontinue features, and we may perform maintenance that causes temporary downtime.
        </p>
      </LegalSection>

      <LegalSection heading="10. Limitation of liability">
        <p>
          To the maximum extent permitted by law, we are not liable for trading losses, lost
          profits, or indirect or consequential damages. Our total liability for any claim is limited
          to the amount you paid us in the 12 months before the claim. Nothing excludes liability for
          fraud, death or personal injury where the law does not permit it.
        </p>
      </LegalSection>

      <LegalSection heading="11. Suspension and termination">
        <p>
          You may close your account at any time. We may suspend or terminate access for material
          breach of these terms, non-payment, security or fraud risk, or repeated or serious policy
          violations.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="12. Changes and contact">
        <p>
          ChartFusionX is owned and operated by{" "}
          <span className="text-foreground">Antonio Hernandez</span> (trading as ChartFusionX). We
          may update these terms; material changes will be posted here with a new date. Questions?
